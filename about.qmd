...
-   Check out resources and practices for synthesisable animal research on the [COReS Hub.](https://www.cores-hub.io){target="_blank"}

-   Stay up-to-date with Community News via the newsletter. [Sign up to the newsletter.](https://eepurl.com/h4hsMv){target="_blank"}

-   Join the discussion forum to share ideas, work collaboratively, and connect with researchers and methodologists. [Make a free user account for the discussion forum here.](https://www.cores.zulipchat.com){target="_blank"}
...
![](/logos/cores-logo.png){#id .class width="80%"}
...
For more information about 3Rs at Charité – Universitätsmedizin Berlin, visit the [Charité 3Rs Toolbox](https://charite3r.charite.de/en/3r_service/charite_3r_toolbox){target="_blank"}.
