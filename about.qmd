...
<br> Find our more about joining the community on the [COReS Hub.](https://cores-hub.io/cores-join-the-community/){target="_blank"} ![](figs/cores-logo.png){#id .class width="80%"}
...
![](figs/C3R_Screen_Farbe.jpg){.class width="20%"}

![](figs/Logo_Volkswagen.png){.class width="50%"}
...
<center>![](/figs/charite-BIHquest.jpg){.class width="30%"}</center>
